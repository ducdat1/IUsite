...
# ])
# AdminUser.create!(email: 'admin@mail.com', password: '12345678', password_confirmation: '12345678')
Webticket.create!([{date: "8/11/2015", title: "I&U in shanghai"},{date: "24/10/2015", title: "Samsung My Challenge Walk Concert"}
])